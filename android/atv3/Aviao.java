...
class Aviao extends Observable{
    ...
    public void setMotorEsquerdo(Motorizavel motorEsq)
    {
        this.motorEsquerdo = motorEsq;
        return; 
    }

    public void setMotorDireito(Motorizavel motorDir)
    {
        this.motorDireito = motorDir;
        return;
    }

    Aviao(String modelo, String identificador, Motorizavel motorEsq, Motorizavel motorDir){
        setModelo(modelo);
